...
os.system('@title AnyDesk IP Resolver^| AnyDesk IP Address Resolver ^| by ogilinux && cls')
...
{12}╚════════════════════════════════════════════╝
				...
				print('hum.')
			input('pritisni\'enter\' da zavrsis...')
			exit()
